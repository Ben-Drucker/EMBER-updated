...
def get_motifs_and_matrices(which_kins, filter_families = None):
    ...
    for wk in which_kins:
        ...
        elif filter_families is None or uniprot_to_fam[uniprot] in filter_families:
...
if __name__ == "__main__":
    ...
    get_motifs_and_matrices(which, filter_families = ['PKC', 'CK2', 'CDK', 'SRC', 'MAPK', 'PKA', 'PIKK', 'AKT'])
